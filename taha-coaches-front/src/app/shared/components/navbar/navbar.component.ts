...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [RouterModule, DarkModeToggleComponent, LanguageToggleComponent, CommonModule],
  template: `
            ...
            <div class="relative" (clickOutside)="closePreferences()">
              ...
              >
                ...
                <div class="flex items-center justify-between mb-3">
                  <span class="text-sm text-secondary dark:text-dark-secondary">Theme</span>
                  <app-dark-mode-toggle></app-dark-mode-toggle>
                </div>

                <!-- Language Row -->
                <div class="flex items-center justify-between">
                  <span class="text-sm text-secondary dark:text-dark-secondary">Language</span>
